...
class CustomAugmentation:
    """Advanced data augmentation with vegetation masking and multiple techniques"""
    def __init__(self, img_size=180, prob=0.5, output_dir="masked_images",
        ...
        # Green vegetation
        self.green_g_min = green_g_min
        self.green_br_max_ratio = green_br_max_ratio
        
        # Brown soil/wood
        self.brown_r_min = brown_r_min
        self.brown_g_min = brown_g_min
        self.brown_b_max = brown_b_max
        
        # Grey-brown vegetation
        self.grey_brown_r_min = grey_brown_r_min
        self.grey_brown_g_min = grey_brown_g_min
        self.grey_brown_b_min = grey_brown_b_min
        self.grey_brown_max_diff = grey_brown_max_diff  # Max difference between any two channels
        
        # Olive/yellow-green vegetation
        self.olive_r_min = olive_r_min
        self.olive_g_min = olive_g_min
        self.olive_r_g_diff_max = olive_r_g_diff_max  # Max difference between R and G channels
        self.olive_b_max = olive_b_max
        
        # Colors to mask out
        # Skin tones
        self.skin_r_min = skin_r_min
        self.skin_r_max = skin_r_max
        self.skin_g_min = skin_g_min
        self.skin_g_max = skin_g_max
        self.skin_b_min = skin_b_min
        self.skin_b_max = skin_b_max
        
        # Blue colors (sky, water, etc.)
        self.blue_b_min = blue_b_min
        self.blue_bg_ratio_min = blue_bg_ratio_min  # Minimum ratio of B to G
        self.blue_br_ratio_min = blue_br_ratio_min  # Minimum ratio of B to R
        
        # Black region avoidance for cropping
        self.black_threshold = black_threshold  # RGB sum threshold to consider a pixel "black"
        self.max_black_percentage = max_black_percentage  # Maximum percentage of black pixels in a crop
    ...
    def __call__(self, img):
        ...
        # Save the masked image to output directory
        filename = f"masked_{uuid.uuid4().hex}.jpg"
